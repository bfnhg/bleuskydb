      ...
      <Menu theme="light" mode="inline">
        ...
        <NavLink to="/ComingSoon">
          <span
            ...
            <span className="label">Real expenses</span>
          </NavLink>
        </Menu.Item>
        <Menu.Item key="6">
        <NavLink to="/ComingSoon">
        ...
        <NavLink to="/ComingSoon">
          <span
            ...
            <span className="label">Real assets</span>
          </NavLink>
        </Menu.Item>
        <Menu.Item key="6">
        <NavLink to="/ComingSoon">
        ...
        <NavLink to="/ComingSoon">
          <span
            ...
            <span className="label">Real Liabilities</span>
          </NavLink>
        </Menu.Item>
        <Menu.Item key="6">
        <NavLink to="/ComingSoon">
        ...
        <NavLink to="/ComingSoon">
          <span
            ...
            <span className="label">Real retained earnings</span>
          </NavLink>
        </Menu.Item>
        <Menu.Item key="6">
        <NavLink to="/ComingSoon">
        ...
        <NavLink to="/ComingSoon">
          <span
            ...
            <span className="label">Prêt</span>
          </NavLink>
        </Menu.Item>
        <Menu.Item key="6">
        <NavLink to="/ComingSoon">
        ...
        <NavLink to="/ComingSoon">
          <span
            ...
            <span className="label">Real investments</span>
          </NavLink>
        </Menu.Item>
        <Menu.Item key="6">
        <NavLink to="/ComingSoon">
        ...
        <NavLink to="/ComingSoon">
          <span
            ...
            <span className="label">Fermeture de mois</span>
          </NavLink>
        </Menu.Item>
        <Menu.Item className="menu-item-header" key="5">
        Flux de trésorier
        ...
        <NavLink to="/ComingSoon">
          <span
            ...
            <span className="label">Réels</span>
          </NavLink>
        </Menu.Item>
        <Menu.Item key="6">
        <NavLink to="/ComingSoon">
