...
function handleSubmit() {
  ...
  <Descriptions contentStyle={{textAlign:'right'}}  bordered column={6} size={"small"} >
    <Descriptions.Item  label="January">{SummaryDetails&&SummaryDetails.januaryCost}</Descriptions.Item>
    <Descriptions.Item  label="February">{SummaryDetails&&SummaryDetails.februaryCost}</Descriptions.Item>
    <Descriptions.Item  label="March">{SummaryDetails&&SummaryDetails.marchCost}</Descriptions.Item>
    <Descriptions.Item  label="April">{SummaryDetails&&SummaryDetails.aprilCost}</Descriptions.Item>
    <Descriptions.Item  label="May">{SummaryDetails&&SummaryDetails.mayCost}</Descriptions.Item>
    <Descriptions.Item  label="June">{SummaryDetails&&SummaryDetails.juneCost}</Descriptions.Item>
    <Descriptions.Item  label="July">{SummaryDetails&&SummaryDetails.julyCost}</Descriptions.Item>
    <Descriptions.Item  label="August">{SummaryDetails&&SummaryDetails.augustCost}</Descriptions.Item>
    <Descriptions.Item  label="September">{SummaryDetails&&SummaryDetails.septemberCost}</Descriptions.Item>
    <Descriptions.Item  label="October">{SummaryDetails&&SummaryDetails.octoberCost}</Descriptions.Item>
    <Descriptions.Item  label="November">{SummaryDetails&&SummaryDetails.novemberCost}</Descriptions.Item>
    <Descriptions.Item  label="December">{SummaryDetails&&SummaryDetails.decemberCost}</Descriptions.Item>
  </Descriptions>
